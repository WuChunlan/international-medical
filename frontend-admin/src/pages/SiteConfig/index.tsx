...
const TARGET_KEYS = ['site_intro', 'contact_default_person', 'contact_default_info'];
  ...
  return (
    <div>
      <Row justify="space-between" align="middle" className="page-header-row">
        <Col>
          <Title level={4} className="page-title">网站配置</Title>
        </Col>
      </Row>
            ...
            <Card
              ...
              title={
                <span>
                  ...
                  <Text type="secondary" className="config-key-hint">
                    ({key})
                  </Text>
                </span>
              }
