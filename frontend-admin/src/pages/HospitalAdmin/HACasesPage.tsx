...
const HACasesPage: React.FC = () => {
  ...
  const openDrawer = (record?: MedicalCase) => {
  ...
  return (
    <div className="page-card">
      <div className="page-header">
        <h3 className="page-title">过往案例</h3>
        <p className="page-description">管理本院医疗案例，提交后等待审核</p>
      </div>
      <div className="page-toolbar">
        <div className="toolbar-left" />
        <Button type="primary" icon={<PlusOutlined />} onClick={() => openDrawer()}>新增案例</Button>
      </div>
